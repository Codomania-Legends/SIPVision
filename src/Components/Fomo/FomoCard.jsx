...
const FomoCard = ({showFomo , setShowFomo}) => {
    return (
        <div className="bg-linear-to-br medium-box-shadow from-indigo-50 to-blue-50 p-6 rounded-2xl shadow-md  w-full max-w-md mt-6">
            ...
            <div className="bg-white p-4 rounded-xl small-box-shadow">
            ...
            <div className='absolute w-2 h-2 rounded-full bg-black text-white top-0 right-0'>X</div>
        </div>
    );
};
